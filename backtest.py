...
def simulate_full_match(home_team: str, away_team: str, base_matrix: pd.DataFrame, df_events: pd.DataFrame, player_profiles: Dict[str, Dict[str, float]], gk_profiles: Dict[str, float], 
                        team_defensive_profiles: Dict[str, Dict[str, float]], manager_profiles: Dict[str, Dict[str, float]], team_to_manager: Dict[str, str], player_to_team: Dict[str, str], 
                        zones: List[str], num_possessions: int = 100) -> Tuple[int, int]:
    """
