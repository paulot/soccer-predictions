...
def simulate_full_match(home_team: str, away_team: str, transition_model: Any, df_events: pd.DataFrame, player_profiles: Dict[str, Dict[str, float]], gk_profiles: Dict[str, float], 
