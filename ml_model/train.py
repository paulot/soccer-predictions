...
def train_models(model_type: str = 'random_forest', mode: str = 'iteration') -> None:
    ...
    if model_type == 'logistic_regression':
        ...
        continuous_cols: List[str] = [c for c in X_train.columns if c not in ['player_role', 'start_zone_x', 'start_zone_y']]
    ...
    if model_type == 'logistic_regression':
        ...
        # Fit and apply scaler only to continuous features (exclude player_role and start_zone_x/y)
        continuous_cols_d: List[str] = [c for c in X_train_d.columns if c not in ['player_role', 'start_zone_x', 'start_zone_y']]
